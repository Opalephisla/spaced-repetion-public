...
export const DeckCard = ({ deck, dueCount, totalCount, onStart }) => {
  return (
    <div className="bg-slate-800 rounded-xl p-8 transition-all hover:ring-2 ring-blue-500 flex flex-col">
      <div className="flex items-center mb-4">
        <Icon type="brain" className="w-8 h-8 text-slate-400" />
        <h2 className="text-2xl font-bold text-white ml-4">{deck.name}</h2>
      </div>
